...
namespace AI {
    ...
    struct GameField {
        ...
        unsigned long Enemy_m_row[AI_POOL_MAX_H];
        bool enemy = false;
        int m_hold;
        int m_pc_att;
        int EBest;
        ...
        /*EnemyGameField() {
            Enemy_row = &Enemy_m_row[gem_add_y];
        }
        EnemyGameField(const GameField& field) {
            Enemy_row = &Enemy_m_row[gem_add_y];
            *this = field;
        }
        EnemyGameField(signed char w, signed char h) {
            Enemy_row = &Enemy_m_row[gem_add_y];
            reset(w, h);
        }*/
        ...
        void Enemyreset(signed char w, signed char h) {
            enemy = false;
            m_w = w;
            m_h = h;
            m_pc_att = 10;
        ...
        */
        ...
        void EnemyaddRow(int rowdata) {
            try {
                for (int h = -gem_add_y + 1; h <= m_h; ++h) {
                    Enemy_row[h - 1] = Enemy_row[h];
                }
                Enemy_row[m_h] = rowdata;
            }
            catch (...) {
                for (int h = -gem_add_y + 1; h <= m_h; ++h) {
                    Enemy_row[h - 1] = Enemy_row[h];
